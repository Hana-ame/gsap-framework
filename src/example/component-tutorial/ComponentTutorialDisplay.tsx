  ...
  useEffect(() => {
    ...
    const stop = startPixiApp((proxy: SubCanvasProxy) => {
      ...
      const panel = root.createRegion(
        ...
        { dragMode: 'none' }, // dragMode: 'none' | 'title' | 'anywhere'
      );
      ...
      const icRegion = root.createRegion(
        { x: 210, y: 50, width: 360, height: 300 },
        { dragMode: 'none' },
      );
      ...
      const CHUNK = 120;                                         // 每个 chunk 120×120 像素
      const ic = new InfiniteCanvas({
        parent: icRegion,
        viewport: { x: 0, y: 0, width: 360, height: 300 },
        chunkSize: CHUNK,
