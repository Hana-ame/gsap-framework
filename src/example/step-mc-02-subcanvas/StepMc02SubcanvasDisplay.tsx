...
const BG_KEYS = Object.keys(IMAGE_MAP);

export function StepMc02SubcanvasDisplay() {
...
StepMc02SubcanvasDisplay.head = {
  title: 'MC Step 02: SubCanvas',
  description: 'ex.moonchan.xyz via Vite proxy + SubCanvas + 点击切换',
};
